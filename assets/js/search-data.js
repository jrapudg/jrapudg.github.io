...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          description: "",
          section: "News",},{id: "news-transferred-phd-program-to-mit-aeroastro",
          title: 'Transferred PhD program to MIT AeroAstro 🚀',
          description: "",
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%6A%72%61%6C%76%61%72%65@%6D%69%74.%65%64%75", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
